...
public class ProductControllerTest {
    ...
    Product RECORD_1 = new Product(1L,10, new BigInteger("99"),"Coca Cola",1001110L);
    Product RECORD_2 = new Product(2L,44, new BigInteger("99"),"Fanta",1001110L);
